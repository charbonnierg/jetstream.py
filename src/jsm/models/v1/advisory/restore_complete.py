...
#   filename:  restore_complete.json
#   timestamp: 2021-07-18T15:28:15+00:00
...
class IoNatsJetstreamAdvisoryV1RestoreComplete(BaseModel):
    type: str
    id: str = Field(..., description="Unique correlation ID for this event")
    timestamp: str = Field(
        ..., description="The time this event was created in RFC3339 format"
    )
    stream: str = Field(..., description="The Stream being restored")
    start: str = Field(..., description="The time the Restore process started")
    end: str = Field(..., description="The time the Restore was completed")
