...
#   filename:  stream_quorum_lost.json
#   timestamp: 2021-07-18T15:28:10+00:00
...
class IoNatsJetstreamAdvisoryV1StreamQuorumLost(BaseModel):
    type: str
    id: str = Field(..., description="Unique correlation ID for this event")
    timestamp: str = Field(
        ..., description="The time this event was created in RFC3339 format"
    )
    stream: str = Field(..., description="The name of the Stream that lost quorum")
    replicas: Replicas
