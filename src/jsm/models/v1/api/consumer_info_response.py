...
#   filename:  consumer_info_response.json
...
class IoNatsJetstreamApiV1ConsumerInfoResponse1(BaseModel):
    type: str
...
class IoNatsJetstreamApiV1ConsumerInfoResponseItem(BaseModel):
...
class IoNatsJetstreamApiV1ConsumerInfoResponseItem1(BaseModel):
    error: Error


class IoNatsJetstreamApiV1ConsumerInfoResponse(BaseModel):
    __root__: Union[
        IoNatsJetstreamApiV1ConsumerInfoResponseItem,
        IoNatsJetstreamApiV1ConsumerInfoResponseItem1,
        IoNatsJetstreamApiV1ConsumerInfoResponse1,
    ] = Field(
        ...,
