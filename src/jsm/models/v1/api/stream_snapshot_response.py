...
#   filename:  stream_snapshot_response.json
...
class IoNatsJetstreamApiV1StreamSnapshotResponse1(BaseModel):
...
class IoNatsJetstreamApiV1StreamSnapshotResponseItem(BaseModel):
    error: Error
...
class IoNatsJetstreamApiV1StreamSnapshotResponseItem1(BaseModel):
    config: Config
    state: State


class IoNatsJetstreamApiV1StreamSnapshotResponse(BaseModel):
    __root__: Union[
        IoNatsJetstreamApiV1StreamSnapshotResponse1,
        IoNatsJetstreamApiV1StreamSnapshotResponseItem,
        IoNatsJetstreamApiV1StreamSnapshotResponseItem1,
    ] = Field(
        ...,
