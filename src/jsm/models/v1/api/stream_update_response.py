...
#   filename:  stream_update_response.json
...
class IoNatsJetstreamApiV1StreamUpdateResponse1(BaseModel):
    type: str
...
class IoNatsJetstreamApiV1StreamUpdateResponseItem(BaseModel):
...
class IoNatsJetstreamApiV1StreamUpdateResponseItem1(BaseModel):
    error: Error2


class IoNatsJetstreamApiV1StreamUpdateResponse(BaseModel):
    __root__: Union[
        IoNatsJetstreamApiV1StreamUpdateResponseItem,
        IoNatsJetstreamApiV1StreamUpdateResponseItem1,
        IoNatsJetstreamApiV1StreamUpdateResponse1,
    ] = Field(
        ...,
