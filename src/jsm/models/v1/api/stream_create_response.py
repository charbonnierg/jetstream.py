...
#   filename:  stream_create_response.json
#   timestamp: 2021-07-18T15:27:58+00:00
...
class IoNatsJetstreamApiV1StreamCreateResponse1(BaseModel):
    type: str
...
class IoNatsJetstreamApiV1StreamCreateResponseItem(BaseModel):
...
class IoNatsJetstreamApiV1StreamCreateResponseItem1(BaseModel):
    error: Error2


class IoNatsJetstreamApiV1StreamCreateResponse(BaseModel):
    __root__: Union[
        IoNatsJetstreamApiV1StreamCreateResponseItem,
        IoNatsJetstreamApiV1StreamCreateResponseItem1,
        IoNatsJetstreamApiV1StreamCreateResponse1,
    ] = Field(
        ...,
