...
#   filename:  stream_template_create_response.json
...
class IoNatsJetstreamApiV1StreamTemplateCreateResponse1(BaseModel):
    type: str
...
class IoNatsJetstreamApiV1StreamTemplateCreateResponseItem(BaseModel):
    config: Config
...
class IoNatsJetstreamApiV1StreamTemplateCreateResponseItem1(BaseModel):
    error: Error


class IoNatsJetstreamApiV1StreamTemplateCreateResponse(BaseModel):
    __root__: Union[
        IoNatsJetstreamApiV1StreamTemplateCreateResponse1,
        IoNatsJetstreamApiV1StreamTemplateCreateResponseItem,
        IoNatsJetstreamApiV1StreamTemplateCreateResponseItem1,
    ] = Field(
        ...,
